...
CALL bash -c "wget -O wix-binaries.zip -nc https://github.com/wixtoolset/wix3/releases/download/wix3111rtm/wix311-binaries.zip && unzip wix-binaries.zip && rm wix-binaries.zip"
